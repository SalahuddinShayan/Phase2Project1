...
public class Add_Assignment extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("addAssignment.html").include(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.append("<html><body>");
		pw.append("Assignment Created successfully!");
		pw.append("<nav> <a href= 'mainMenu.html'>Click here to go to Main Menu</a><br>");
		pw.append("<a href= 'addAssignment.html'>Click here to Create another Assignment.</a></nav>");
		pw.append("</body></html>");
	}
	catch(PersistenceException  | NumberFormatException e) {
		PrintWriter out = response.getWriter();
		out.println("<html><body>");
		out.println("<a>ERROR! Please Make Sure that Assign ID you have given is Not already Used and that you are giving valid Input.</a><br>");
		...
		out.println("<a href= 'addAssignment.html'>Click here to try again.</a></nav>");
