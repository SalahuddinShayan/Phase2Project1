...
public class Update_Class extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("UpdateClass.html").include(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.append("<html><body>");
		pw.append("Class updated successfully!");
		pw.append("<nav> <a href= 'mainMenu.html'>Click here to go to Main Menu</a><br>");
		pw.append("<a href= 'updateClass.html'>Click here to Update another class.</a></nav>");
		pw.append("</body></html>");
	}
		...
		out.println("<a href= 'updateClass.html'>Click here to try again.</a></nav>");
