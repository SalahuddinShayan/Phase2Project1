...
/**
 * Servlet implementation class Delete_Teacher
 */
...
public class Delete_Teacher extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.append("<html><body>");
		pw.append("Teacher delete successfully!");
		pw.append("<nav> <a href= 'mainMenu.html'>Click here to go to Main Menu</a><br>");
		pw.append("<a href= 'deleteTeacher.html'>Click here to delete another teacher.</a></nav>");
		pw.append("</body></html>");
	}
		...
		out.println("<a href= 'deleteTeachers.html'>Click here to try again.</a></nav>");
